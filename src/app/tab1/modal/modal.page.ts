...
export class ModalPage implements OnInit {
  ...
  async addImage() {
    ...
    this.modalUser.profileImg = this.imgPath;
    console.log('form modal recieved img path ' + this.imgPath);
    console.log('form modal obj img path ' + this.modalUser.profileImg);
  }
  ...
  sendData() {
    console.log('form modal obj modal user ' + this.modalUser);
    console.log('form modal obj img path ' + this.modalUser.profileImg);
